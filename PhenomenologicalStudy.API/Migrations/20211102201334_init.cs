        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    UpdatedTime = table.Column<DateTimeOffset>(type: "datetimeoffset", nullable: false, defaultValueSql: "SYSDATETIMEOFFSET()")
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_ChildEmotions_Children_ChildId",
                        column: x => x.ChildId,
                        principalTable: "Children",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_ChildEmotions_Emotions_EmotionId",
            ...
            migrationBuilder.CreateTable(
                ...
                {
                    Id = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                    ChildEmotionId = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                    ImageId = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Reflections_ChildEmotions_ChildEmotionId",
                        column: x => x.ChildEmotionId,
                        principalTable: "ChildEmotions",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade,
                        onUpdate: ReferentialAction.SetNull);
                    table.ForeignKey(
                        name: "FK_Reflections_Comments_CommentId",
                        ...
                        onUpdate: ReferentialAction.SetNull);
                    table.ForeignKey(
                        name: "FK_Reflections_Images_ImageId",
                        column: x => x.ImageId,
                        principalTable: "Images",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ExpiryDate = table.Column<DateTimeOffset>(type: "datetimeoffset", nullable: false, defaultValueSql: "SYSDATETIMEOFFSET()")
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_UserReflections_AspNetUsers_UserId",
                        column: x => x.UserId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_UserReflections_Reflections_ReflectionId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ChildEmotions_ChildId",
                table: "ChildEmotions",
                column: "ChildId");

            migrationBuilder.CreateIndex(
                name: "IX_ChildEmotions_EmotionId",
                table: "ChildEmotions",
                column: "EmotionId");

            migrationBuilder.CreateIndex(
                name: "IX_Reflections_ChildEmotionId",
                table: "Reflections",
                column: "ChildEmotionId");

            migrationBuilder.CreateIndex(
                name: "IX_Reflections_CommentId",
                table: "Reflections",
                column: "CommentId");

            migrationBuilder.CreateIndex(
                name: "IX_Reflections_ImageId",
                table: "Reflections",
                column: "ImageId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_UserReflections_ReflectionId",
